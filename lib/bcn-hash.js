...
function hashString(data) {
	if (crypto && crypto.createHash) {
		...
		return hashStringBrowser(data);
	}
}

function hashStringBrowser(data) {
	var sha = Crypto.SHA1(data);
	sha = sha.replace(hash_regex, hash_regex_function);
...
/*
Following parts taken from http://code.google.com/p/crypto-js
 Crypto.util and SHA1.js from 
...
var SHA1 = C.SHA1 = function (message, options) {
	...
	return util.bytesToBase64(digestbytes);
};
